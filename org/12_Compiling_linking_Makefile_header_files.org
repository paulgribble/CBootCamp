...
#+INCLUDE: "~/Desktop/CBootCamp/code/neurons/go.c" src c
...
#+INCLUDE: "~/Desktop/CBootCamp/code/neurons/neuron.h" src c
...
#+INCLUDE: "~/Desktop/CBootCamp/code/primes/primes.h" src c

So we know a couple of things from this header file. First, it
requires the =math.h= standard C library, so we will need to add the
=-lm= compiler flag to the command we use to compile our
program. Second, it declares a function prototype for =isPrime()=. We
...
#+INCLUDE: "~/Desktop/CBootCamp/code/primes/primes.c" src c

Here is what our program [[file:code/primes/go.c][go.c]] looks like:

#+INCLUDE: "~/Desktop/CBootCamp/code/primes/go.c" src c
...
A simple Makefile ([[file:code/primes/Makefile1.txt][Makefile1.txt]]) for our prime number program above
might look like this:

#+INCLUDE: "~/Desktop/CBootCamp/code/primes/Makefile1.txt" src sh
...
is what a more generalized Makefile ([[file:code/primes/Makefile2.txt][Makefile2.txt]]) might look like for
our primes example from above:

#+INCLUDE: "~/Desktop/CBootCamp/code/primes/Makefile2.txt" src sh
